...
const FollowersCard = () => {
  ...
  return (
    <div className="">
      <div className=" mx-auto rounded-lg overflow-hidden shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-[#e4e4e4]">
        <div className="border-b px-4 pb-6">
          ...
          <div className="flex gap-2 px-2">
            <button
              className={`flex-1 rounded-full  text-white antialiased font-bold px-4 py-2 ${
        ...
        <div className="px-4 py-4">
          <div className="flex flex-row justify-center gap-2 items-center text-gray-800r mb-4">
            <svg
